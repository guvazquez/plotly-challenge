...
function plotBubbleData(id){
    ...
    trace = {
        ...
        marker: {
            ...
            color: ["rgba(255, 165, 0, 0.6)", "rgba(255, 165, 0, 0.6)", "rgba(255, 165, 0, 0.6)", "rgba(255, 165, 0, 0.6)", "rgba(255, 165, 0, 0.6)","rgba(255, 165, 0, 0.6)", "rgba(255, 165, 0, 0.6)", "rgba(255, 165, 0, 0.6)", "rgba(255, 165, 0, 0.6)","rgba(255, 165, 0, 0.6)"]
        }
    };
